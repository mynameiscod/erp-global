...
| Audit chain                       | Detects any edited, deleted or inserted record, and a truncated tail. Someone with database write access could rewrite _all_ records from the tampered point onward.                                                                                                      | Periodically publish signed chain checkpoints outside the database.                  |
